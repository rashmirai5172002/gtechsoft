...
export default function Navbar() {
  ...
  return (
    <header className="bg-white py-4 md:py-5 lg:py-7 px-4 md:px-5 relative z-50">
      <Container>
        <div className="flex items-center justify-between">

          {/* LOGO */}
          <div className="flex items-center gap-2 md:gap-3">
            <img src="/logo.svg" alt="Gtechsoft" className="h-8 md:h-9 lg:h-10 w-auto" />

            <span className="hidden sm:block w-[1px] h-6 md:h-7 lg:h-8 bg-gray-300"></span>

            <p className="hidden sm:block w-[110px] md:w-[120px] lg:w-[138px] text-[12px] md:text-[13px] lg:text-[15px] text-gray-800 font-medium">
              Built for the World
            </p>
          </div>
          ...
          <button
            className="lg:hidden text-2xl dark:text-black "
            onClick={() => setMenuOpen(!menuOpen)}
          >
            ☰
          </button>
          ...
          >
            ...
            {/* NAV LINKS */}
            <nav className="flex flex-col lg:flex-row gap-5 lg:gap-6 text-sm text-[#444444] font-medium">
              ...
              <div className="relative">
                ...
                {serviceOpen && (
                  <div className="mt-2 lg:absolute lg:top-full lg:left-0 bg-white shadow-lg rounded-md p-3 w-full lg:w-52">
                    <a className="block p-2 hover:bg-gray-100">Web Development</a>
                    <a className="block p-2 hover:bg-gray-100">App Development</a>
                    <a className="block p-2 hover:bg-gray-100">UI/UX Design</a>
                  </div>
            ...
            {/* BUTTON */}
            <div className="flex items-center gap-0 mt-4 lg:mt-0">

              <button className="bg-[#1f1f1f] text-white px-5 md:px-6 py-2.5 md:py-3 rounded-full text-sm font-medium">
                Get Started
              </button>

              <button className="bg-[#F79A01] h-10 w-10 md:h-11 md:w-11 lg:h-12 lg:w-12 rounded-full flex items-center justify-center">
                <ArrowUpRight size={16} className="text-black" />
              </button>
